...
# <1>: Example for using watchdog library for live watching files
# <2>: Printing deck at begin and end of every step
# <3>: get_trimmed_packet_tree function using example
# <4>: get_packets_by_step function using example
